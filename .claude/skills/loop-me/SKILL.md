...
Run a stateful, one-question-at-a-time interview (the same relentless discipline as `/plan-interview`) whose only output is **workflow** specs. Use the grilling discipline — relentless, one question at a time, a recommended answer attached to each — aimed at the vocabulary and goal below. Create, edit, and delete specs as the grilling resolves things.
